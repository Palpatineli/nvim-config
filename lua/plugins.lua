...
require('lazy').setup({
    ...
    {'hrsh7th/cmp-nvim-lsp', 'hrsh7th/cmp-buffer', 'hrsh7th/cmp-path', 'hrsh7th/cmp-cmdline',
        'saadparwaiz1/cmp_luasnip', dependencies={'neovim/nvim-lspconfig', 'hrsh7th/nvim-cmp',
            "williamboman/mason.nvim", "williamboman/mason-lspconfig.nvim", "SmiteshP/nvim-navic"},
